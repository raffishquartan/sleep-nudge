...
Previous design (per-run web_search + web_fetch with Sonnet 4.6): ~$6-$10/month, ~194k input tokens per day. This design: ~$0/month for the daily send. Generation runs on Chris's Claude subscription as a normal interactive or scheduled session.
